            ...
            <div class="row pt-3">
                <div class="col ps-4">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-person-lines-fill me-3"></i> {{ __('Total Students') }}</div>
                                        </div>
                        ...
                        <div class="col">
                            <div class="card rounded-pill">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-person-lines-fill me-3"></i> {{ __('Total Teachers') }}</div>
                                        </div>
                        ...
                        <div class="col">
                            <div class="card rounded-pill">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-diagram-3 me-3"></i> {{ __('Total Classes') }}</div>
                                        </div>
                    ...
                    <div class="mt-3 d-flex align-items-center">
                        <div class="col-3">
                            <span class="ps-2 me-2">{{ __('Students %') }}</span>
                            <span class="badge rounded-pill border" style="background-color: #0678c8;">{{ __('Male') }}</span>
                            <span class="badge rounded-pill border" style="background-color: #49a4fe;">{{ __('Female') }}</span>
                        </div>
                        @php
                    ...
                    <div class="row align-items-md-stretch mt-4">
                        <div class="col">
                            <div class="p-3 text-white bg-dark rounded-3">
                                <h3>{{ __('Welcome to Unifiedtransform!') }}</h3>
                                <p><i class="bi bi-emoji-heart-eyes"></i> {{ __('Thanks for your love and support.') }}</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                <h3>{{ __('Manage school better') }}</h3>
                                <p class="text-end">{{ __('with') }} <i class="bi bi-lightning"></i> <a href="https://github.com/changeweb/Unifiedtransform" target="_blank" style="text-decoration: none;">Unifiedtransform</a> <i class="bi bi-lightning"></i>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="card-header bg-transparent"><i class="bi bi-calendar-event me-2"></i> {{ __('Events') }}</div>
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="card-header bg-transparent d-flex justify-content-between"><span><i class="bi bi-megaphone me-2"></i> {{ __('Notices') }}</span> {{ $notices->links() }}</div>
                                <div class="card-body p-0 text-dark">
                                    <div>
                                        ...
                                        <div class="accordion accordion-flush" id="noticeAccordion">
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="flush-heading{{$notice->id}}">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse{{$notice->id}}" aria-expanded={{($loop->first)?"true":"false"}} aria-controls="flush-collapse{{$notice->id}}">
                                                        {{ __('Published at:') }} {{$notice->created_at}}
                                                    </button>
                                                </h2>
                                            ...
                                            @endisset
                                            @if(count($notices) < 1)
                                                <div class="p-3">{{ __('No notices') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
